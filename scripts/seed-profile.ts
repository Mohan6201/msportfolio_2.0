...
await db.insert(certifications).values([
  ...
  },
  {
    ...
    imageUrl: "/images/ASA Certificate.jfif",
    sortOrder: 1,
  },
  {
    profileId: profile.id,
