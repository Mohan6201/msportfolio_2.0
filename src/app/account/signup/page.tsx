  ...
  return (
    <main className="min-h-screen bg-darkBrown flex items-center justify-center px-4">
      <div className="glass rounded-2xl border border-white/10 p-8 w-full max-w-sm">
        <h1 className="font-special text-2xl font-bold text-white mb-2">Create Account</h1>
        <p className="text-lightGrey text-sm font-mono mb-6">MS Portfolio · Career Centre</p>

        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="block text-xs font-mono text-lightGrey mb-1">Name</label>
            <input
              type="text"
              value={name}
        ...
        <p className="text-center text-xs font-mono text-lightGrey mt-6">
          ...
          <Link href="/account/login" className="text-cyan hover:underline">
            Sign in
          </Link>
        </p>
      </div>
