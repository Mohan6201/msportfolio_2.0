...
export default function PreferencesForm() {
  ...
  const inputCls = "w-full rounded-lg px-3 py-2.5 text-sm font-mono text-white placeholder-[#333] focus:outline-none focus:ring-2 focus:ring-cyan/60 transition-colors";
