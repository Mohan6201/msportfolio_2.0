...
export default function CareerCentreSection() {
  return (
    <section id="career-centre" className="py-24 px-4 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14">
          <div>
            ...
            <p className="text-lightGrey text-sm font-mono mt-3 max-w-md">
          ...
          <Link
            href="/account/signup"
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-cyan text-black font-mono font-bold text-sm hover:bg-lightCyan transition-colors shadow-cyanShadow flex-shrink-0 self-start sm:self-auto"
          >
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className={`font-special font-bold text-base text-white mb-2 group-hover:text-${tool.color} transition-colors`}>
                    {tool.title}
                  </h3>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-white/5">
                  ...
                  <div className={`flex items-center gap-1 text-[10px] font-mono text-${tool.color}`}>
        ...
        {/* Bottom CTA bar */}
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 p-5 rounded-2xl glass border border-cyan/10">
          <div>
          ...
          <Link
            href="/account/login"
            className="flex items-center gap-2 px-4 py-2 rounded-xl border border-cyan/30 text-cyan text-sm font-mono hover:bg-cyan/8 transition-all flex-shrink-0"
          >
