...
const SingleSkill = ({ imgSvg, text }: SingleSkillProps) => {
  return (
    <div className="hover:-translate-y-10 transition-all duration-500">
      <div className="flex flex-col items-center gap-2 relative">
        ...
        <p className="text-white font-bold text-wrap text-center">{text}</p>
      </div>
      <div className="w-[100px] h-[200px] bg-orange absolute top-[50px] -z-10" />
    </div>
  );
};
